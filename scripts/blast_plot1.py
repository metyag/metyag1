...
blast_G_muris = pd.read_csv('/home/metyag/Desktop/deneme/metyag1/output/blastn/G_intestinalis/G_muris.blastn', sep='\t', header=None)
blast_S_salmonicida = pd.read_csv('/home/metyag/Desktop/deneme/metyag1/output/blastn/G_intestinalis/S_salmonicida.blastn', sep='\t', header=None)
